...
func (e *BigOne) ClosePosition(instId, mgnMode, posSide string, options ...interface{}) bool {
	return true
}

// 策略下单，提供止盈止损
func (e *BigOne) TradeAlgo(instId, tdMode, side, ordType, sz string, options map[string]interface{}) interface{} {
	return nil
}
